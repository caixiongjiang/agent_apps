    ...
    def get_manager(
        ...
        if db_type == "sqlite":
            ...
            manager = MySQLServerManager(
                ...
                max_overflow=kwargs.get("max_overflow") if "max_overflow" in kwargs else mysql_config.get(
                    "max_overflow", 10),
                pool_timeout=kwargs.get("pool_timeout") if "pool_timeout" in kwargs else mysql_config.get(
                    "pool_timeout", 30),
                pool_recycle=kwargs.get("pool_recycle") if "pool_recycle" in kwargs else mysql_config.get(
                    "pool_recycle", 3600),
